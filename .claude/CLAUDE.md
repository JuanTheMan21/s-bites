...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-24 (commit 6b52ec2). Confidence: 100%.
...
- `handoff.md` — 5 commits/90d
- `decisionlog.md` — 5 commits/90d
- `tasks.md` — 5 commits/90d

### Code health
Three co-equal signals: defect risk 9.48/10 avg, hotspot health 7.9/10 (stable), worst `.claude/CLAUDE.md` at 7.9/10 · maintainability 9.85/10 · performance risk 10 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit 400abb8). Confidence: 100%.
...
- `tests/block_examples.py` — 2 bug fixes, last fix today; 4 commits/90d
- `tests/graph_pipeline_fixtures.py` — 2 bug fixes, last fix today; 6 commits/90d
- `tests/test_runtime_skills.py` — 2 bug fixes, last fix today; 6 commits/90d
- `rendering/annotations.py` — 2 bug fixes, last fix today; 4 commits/90d
- `rendering/block_timing.py` — 2 bug fixes, last fix today; 3 commits/90d

### Code health
Three co-equal signals: defect risk 8.85/10 avg, hotspot health 7.45/10 (stable), worst `tests/test_graph_pipeline.py` at 5.85/10 · maintainability 9.87/10 · performance risk 18 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `scripts/measure_segment_concurrency.py` — change entropy — impact −3.0
- `core/block_types.py` — untested hotspot — impact −2.0
- `tests/test_graph_pipeline.py` — churn risk — impact −1.8
- `tasks.md` — hidden coupling — impact −1.6
- `handoff.md` — hidden coupling — impact −1.4

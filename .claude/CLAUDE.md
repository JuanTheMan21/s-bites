...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit 8ebda33). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 7.4/10 avg, hotspot health 7.58/10 (stable), worst `.claude/skills/impeccable/scripts/context.mjs` at 3.35/10 · maintainability 7.39/10 · performance risk 348 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `core/block_types.py` — untested hotspot — impact −2.0
- `.claude/CLAUDE.md` — hidden coupling — impact −0.9
- `.claude/CLAUDE.md` — hidden coupling — impact −0.9
- `tasks.md` — hidden coupling — impact −0.9
- `tasks.md` — hidden coupling — impact −0.9

...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-05 (commit d3fd03d). Confidence: 100%.
...
- `rendering/block_timing.py` — 4 bug fixes, last fix today (bug magnet); 5 commits/90d
- `tests/test_item_anchor_resolution.py` — 3 bug fixes, last fix today; 3 commits/90d
- `rendering/annotations.py` — 3 bug fixes, last fix today; 6 commits/90d
- `tests/graph_pipeline_fixtures.py` — 3 bug fixes, last fix today; 8 commits/90d
- `rendering/compose.py` — 2 bug fixes, last fix today; 6 commits/90d

### Code health
Three co-equal signals: defect risk 7.34/10 avg, hotspot health 6.79/10 (stable), worst `.claude/skills/impeccable/scripts/context.mjs` at 3.35/10 · maintainability 7.53/10 · performance risk 212 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `rendering/templates/_tokens.html` — change entropy — impact −3.0
- `rendering/templates/_captions.html` — change entropy — impact −3.0
- `CLAUDE.md` — change entropy — impact −2.9

...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-06 (commit 3db66d3). Confidence: 100%.
...
- `rendering/block_timing.py` — 4 bug fixes, last fix today (bug magnet); 6 commits/90d
- `tests/test_item_anchor_resolution.py` — 3 bug fixes, last fix today; 4 commits/90d
- `rendering/annotations.py` — 3 bug fixes, last fix today; 7 commits/90d
- `tests/graph_pipeline_fixtures.py` — 3 bug fixes, last fix yesterday; 8 commits/90d
- `rendering/compose.py` — 2 bug fixes, last fix today; 7 commits/90d

### Code health
Three co-equal signals: defect risk 7.36/10 avg, hotspot health 6.75/10 (stable), worst `.claude/skills/impeccable/scripts/context.mjs` at 3.35/10 · maintainability 7.6/10 · performance risk 212 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

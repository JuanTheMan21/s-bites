...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-24 (commit b3dcf83). Confidence: 100%.
...
- `handoff.md` — 7 commits/90d
- `decisionlog.md` — 7 commits/90d
- `tasks.md` — 6 commits/90d

### Code health
Three co-equal signals: defect risk 9.6/10 avg, hotspot health 8.45/10 (stable), worst `tasks.md` at 7.9/10 · maintainability 9.86/10 · performance risk 11 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

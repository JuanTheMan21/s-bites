...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit 5fa267a). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.9/10 avg, hotspot health 7.62/10 (stable), worst `core/scene_schemas.py` at 6.44/10 · maintainability 9.87/10 · performance risk 17 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `core/block_types.py` — untested hotspot — impact −2.0
- `tasks.md` — hidden coupling — impact −1.6
- `handoff.md` — hidden coupling — impact −1.4
- `decisionlog.md` — hidden coupling — impact −0.8
- `decisionlog.md` — hidden coupling — impact −0.8

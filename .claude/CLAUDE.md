...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-01 (commit 5ab4ca5). Confidence: 100%.
...
- `rendering/annotations.py` — 2 bug fixes, last fix today; 3 commits/90d
- `rendering/block_timing.py` — 2 bug fixes, last fix today; 3 commits/90d

### Code health
Three co-equal signals: defect risk 8.93/10 avg, hotspot health 7.56/10 (stable), worst `tests/test_render_segment.py` at 5.65/10 · maintainability 9.88/10 · performance risk 18 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `.claude/CLAUDE.md` — hidden coupling — impact −0.9
- `.claude/CLAUDE.md` — hidden coupling — impact −0.9

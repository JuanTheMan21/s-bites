...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-22 (commit ba1cbce). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 9.89/10 avg, hotspot health 9.89/10 (stable), worst `scripts/hook_py_quality.py` at 8.85/10 · maintainability 9.96/10 · performance risk 5 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-26 (commit 503bf68). Confidence: 100%.
...
- `handoff.md` — 9 commits/90d
- `decisionlog.md` — 9 commits/90d
- `tasks.md` — 8 commits/90d
- `rendering/templates/_tokens.html` — 3 commits/90d
- `tests/test_graph_pipeline.py` — 4 commits/90d

### Code health
Three co-equal signals: defect risk 9.19/10 avg, hotspot health 7.44/10 (stable), worst `.claude/CLAUDE.md` at 6.5/10 · maintainability 9.86/10 · performance risk 11 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `.claude/CLAUDE.md` — hidden coupling — impact −1.0
- `.claude/CLAUDE.md` — hidden coupling — impact −1.0
- `handoff.md` — hidden coupling — impact −1.0
- `handoff.md` — hidden coupling — impact −1.0
- `decisionlog.md` — hidden coupling — impact −1.0

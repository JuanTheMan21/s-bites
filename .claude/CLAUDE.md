...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-23 (commit 224804c). Confidence: 100%.
...
- `decisionlog.md` — 3 commits/90d
- `handoff.md` — 3 commits/90d
- `tasks.md` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 9.79/10 avg, hotspot health 10.0/10 (stable), worst `adapters/azure/llm_provider.py` at 7.99/10 · maintainability 9.84/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

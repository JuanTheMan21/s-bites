...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-24 (commit 5e0eb9a). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 9.53/10 avg, hotspot health 7.9/10 (stable), worst `decisionlog.md` at 7.9/10 · maintainability 9.86/10 · performance risk 11 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

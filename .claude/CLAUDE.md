...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-29 (commit 01f9532). Confidence: 100%.
...
- `handoff.md` — 13 commits/90d
- `decisionlog.md` — 14 commits/90d
- `tasks.md` — 11 commits/90d
- `rendering/templates/_tokens.html` — 3 commits/90d
- `rendering/compose.py` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 9.19/10 avg, hotspot health 7.59/10 (stable), worst `.claude/CLAUDE.md` at 4.94/10 · maintainability 9.86/10 · performance risk 18 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `tests/test_graph_pipeline.py` — churn risk — impact −1.5
- `core/models.py` — change entropy — impact −1.5

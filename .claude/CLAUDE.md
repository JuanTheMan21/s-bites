...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-31 (commit 376e85e). Confidence: 100%.
...
- `handoff.md` — 16 commits/90d
- `decisionlog.md` — 17 commits/90d
- `tasks.md` — 13 commits/90d
- `rendering/compose.py` — 4 commits/90d
- `rendering/templates/_tokens.html` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 9.13/10 avg, hotspot health 7.49/10 (stable), worst `tests/test_render_segment.py` at 5.65/10 · maintainability 9.87/10 · performance risk 18 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `scripts/measure_segment_concurrency.py` — change entropy — impact −3.0
- `tests/test_graph_pipeline.py` — churn risk — impact −1.8
- `tasks.md` — hidden coupling — impact −1.1
- `tasks.md` — hidden coupling — impact −1.1
- `handoff.md` — hidden coupling — impact −1.1

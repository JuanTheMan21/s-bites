...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-01 (commit 4f10ae7). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.9/10 avg, hotspot health 7.44/10 (stable), worst `tasks.md` at 4.94/10 · maintainability 9.88/10 · performance risk 18 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `tasks.md` — hidden coupling — impact −1.0
- `tasks.md` — hidden coupling — impact −1.0

...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-26 (commit 655b355). Confidence: 100%.
...
- `handoff.md` — 8 commits/90d
- `decisionlog.md` — 8 commits/90d
- `tasks.md` — 7 commits/90d
- `tests/test_graph_pipeline.py` — 3 commits/90d
- `core/graph/pipeline.py` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 9.47/10 avg, hotspot health 7.74/10 (stable), worst `tasks.md` at 6.34/10 · maintainability 9.84/10 · performance risk 11 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

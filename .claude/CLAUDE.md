...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-23 (commit b4df19f). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 9.91/10 avg, hotspot health 9.91/10 (stable), worst `scripts/hook_py_quality.py` at 8.85/10 · maintainability 9.94/10 · performance risk 6 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-06 (commit 9b9e9c2). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 7.32/10 avg, hotspot health 6.59/10 (stable), worst `.claude/skills/impeccable/scripts/context.mjs` at 3.35/10 · maintainability 7.57/10 · performance risk 212 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
